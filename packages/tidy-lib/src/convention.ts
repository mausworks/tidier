...
export type NameFormat =
  | (GeneralCasing | GeneralAlias)[]
  | [...(GeneralCasing | GeneralAlias)[], ExtensionCasing];
...
export const resolveCasing = (
  casingOrAlias: GeneralAlias | GeneralCasing | ExtensionCasing
